...
const validateMail = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <TextInput style={styles.inputText}
      label="Sobrenome"
      placeholder="Informe o sobrenome" onChangeText={lastName => setLastNameText(lastName)} defaultValue={lastName} />
      ...
      <TextInput style={styles.inputText}
      label="E-mail" 
      placeholder="Informe seu e-mail" onChangeText={email => setEmailText(email)} defaultValue={email}  />
      ...
      placeholder="Informe sua senha" onChangeText={passoword => setPasswordText(passoword)}  right={ <TextInput.Icon name="eye" onPress={() => {setSecureTextEntry(!secureTextEntry); return false;}} />} />
      ...
      validateA11()} style={styles.buttonstyle} color="#000000" />
